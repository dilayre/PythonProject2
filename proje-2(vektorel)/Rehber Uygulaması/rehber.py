...
def listele():
    try:
        ...
        a=input("Devam etmek için entera basınız.")
...
def kayitDuzenle():
    try:
        ...
        numara = int(input("Düzenlemek istediğiniz kaydın numarasını girin:"))
...
def kayitSil():
    try:
        ...
        numara = int(input("Silmek istediğiniz kaydın numarasını girin:"))
